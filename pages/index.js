...
const HomePage = () => {
  ...
  return(
    <>
      <MetaComponent title="See. Explore. Code.｜Riva Hsu" />
      {!hideLoading && (
      ...
      <div className={stylesIndex.wrapper}>
            ...
            >
              <div className={`KvBlock KvBlockCenterW1100 ${stylesIndex.KvSpc}`}>
                ...
                {/* <a href="https://github.com/tingm1020?tab=projects" target="_blank" className="BtnSingle">Read More</a> */}
                <button
                  className="BtnSingle"
                  onClick={() => {
                    sectionRefs.current['introPlugin']?.scrollIntoView({ behavior: 'smooth'});
                  }}
                >
                  Start
                </button>
